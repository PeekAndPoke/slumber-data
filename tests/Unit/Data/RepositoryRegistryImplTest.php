...
class RepositoryRegistryImplTest extends TestCase
{
    ...
    public function testGetRepositoryByName()
    {
        ...
        $subject->registerProvider('repo1', [UnitTestDataMainClass::class], function () use (&$repo1) {
            $repo1 = $this->getMockBuilder(Repository::class)->getMock();

            return $repo1;
        });

        $subject->registerProvider('repo2', [UnitTestDataAggregatedClass::class], function () use (&$repo2) {
    ...
    public function testGetRepositoryByNameAndClassReturnsTheSameInstance()
    {
        ...
        $repo1ByClass = $subject->getRepositoryByClassName(UnitTestDataMainClass::class);
