...
use PeekAndPoke\Component\Slumber\Stubs\UnitTestDataJournalizedClass;
...
class JournalWorksMongoDbFeatureTest extends SlumberMongoDbTestBase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        $registry->registerProvider(self::COLLECTION, [UnitTestDataJournalizedClass::class], function (ProviderContext $context) use ($entityPool, $codecSet) {
    ...
    /**
     * @return UnitTestDataJournalizedClass
     */
    private function storeItemTwice()
    {
        $item = new UnitTestDataJournalizedClass();
        $item->setName('name1');
        $item->setAge(1);
